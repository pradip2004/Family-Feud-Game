  ...
  return (
    <div className="w-full h-screen bg-pink-900 flex flex-col items-center p-4 relative">
      <div className="header w-full h-[10%] bg-pink-700 flex items-center justify-between px-3 rounded-lg shadow-md">
        ...
        <button className="bg-yellow-500 px-4 py-2 rounded-full text-white font-semibold shadow-lg">
          Log Out
        </button>
      </div>
      ...
      <div className="absolute px-3 py-5 bg-pink-700 shadow-2xl rounded-full bottom-5 right-5 text-white font-semibold cursor-pointer" onClick={()=>socket.emit("play_sound")}>
        Music
      </div>
    </div>
  );
